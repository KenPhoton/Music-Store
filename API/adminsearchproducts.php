<?php
	...
	else
	{
		...
		$sql = "SELECT * from Product where productname like '%" . $_POST["search"] . "%' or category like '%" . $_POST["search"] . "%' or description like '%" . $_POST["search"] . "%' or picname like '%" . $_POST["search"] . "%'";
