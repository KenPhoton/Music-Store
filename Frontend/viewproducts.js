		...
		try
		{
			...
			else
			{
                ...
                else
                {
                    ...
                    alert(alerttext + "Successfully finalized purchase! Your discount code expires at 11:59 PM EDT on " + someFormattedDate + ". The current number of purchases associated with this discount is " + count + ".");
